...
# The purpose of this is to compute how similar two songs or soundwaves are by reading a wav file of each then using PyTorch's pitch detection algorithm to determine their MSEs
...
def pitch_detection_comparison(id1, id2):
  ...
  p1 = torchaudio.functional.detect_pitch_frequency(song1, fs1)
  p2 = torchaudio.functional.detect_pitch_frequency(song2, fs2)
